  ...
  return (
    ...
    >
      <div className="flex min-h-full items-start justify-center p-4 md:p-8">
        ...
        >
          {(title || !hideClose) && (
            <div className="flex items-start justify-between gap-3 px-5 py-4 border-b border-line sticky top-0 bg-surface/95 backdrop-blur rounded-t-lg z-10">
          ...
          {footer && (
            <div className="px-5 py-3 border-t border-line bg-surface rounded-b-lg flex items-center justify-end gap-2 sticky bottom-0 z-10">
              {footer}
            </div>
          )}
        </div>
